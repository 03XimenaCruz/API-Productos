...
import { FaChartBar, FaTable } from "react-icons/fa"; // Importamos iconos

const App = () => {
  const [products, setProducts] = useState([]);
  const [search, setSearch] = useState("");
  const [view, setView] = useState("table"); // Estado para alternar vista
      ...
      <div className="bg-white p-6 shadow-md rounded-lg w-11/12 max-w-6xl">
        <div className="flex justify-between items-center mb-4">
          ...
          >
            ...
            {view === "table" ? "Ver Gráfico" : "Ver Tabla"}
          </button>
        </div>
